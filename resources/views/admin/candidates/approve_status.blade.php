            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-xl ">
                <div class="p-2 text-gray-600 font-bold border-4 border-transparent border-l-amber-400 flex justify-between items-center">
                    <div class="ml-2">
                        ...
                        /
                        <a href="{{ route('admin.approve_application') }}" class="text-amber-400 hover:text-gray-300">
            ...
            <div class="p-2 mb-4 mt-4">
                    ...
                    <div class="relative overflow-x-auto shadow-xl rounded-lg mx-5 ">
                        <table class="w-full text-sm text-left text-gray-600">
                            ...
                            @empty
                            <tr>
                               <td scope="row" class="px-6 py-4 text-md dark:text-gray-900 whitespace-nowrap text-white"> No records of approve application . . . </td>
                            </tr>
                            @endforelse
                            <!-- loop end here -->
                            </tbody>
