<x-guest-layout>
    ...
    <div class="flex min-h-full items-center justify-center py-8 px-4 sm:px-6 lg:px-8 bg-white shadow-lg rounded-lg">
      ...
      <div class="flex justify-center items-center">
         ...
         <h2 class="mt-6 text-center text-5xl font-bold tracking-tight text-gray-800"> <span class="text-indigo-500 "> Professor Login</span></h2>
         <p class="mt-4 text-center font-medium text-gray-800 ">
                  Or sign in as&nbsp;
                  <a href="{{ route('login') }}" class="flex-none rounded-full bg-gray-900 py-1 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">
                  Student 
