...
<div class="flex h-full items-center justify-center py-8 px-4 mt-12 sm:px-6 lg:px-8 bg-white shadow-lg rounded-lg">
      ...
      <div class="flex justify-center items-center">
         ...
         <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-800"> <span class="text-indigo-500 "> Professor Registration</span></h2>
    ...
    <form method="POST" action="{{ route('register-professor') }}">
        ...
        <div class="col-span-6 mt-4 sm:col-span-6 lg:col-span-3">
          <x-input-label for="user_type" :value="__('Employee Type')" />
          <select id="user_type" name="user_type" autocomplete="user_type" required="" :value="old('user_type')" class="mt-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
